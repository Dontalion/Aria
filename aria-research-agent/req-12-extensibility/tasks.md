# Tasks — Req 12: Extensibility for New Research Topics

## Dependencies

- Req 07 (Configuration) — supplies and validates topic, subtopics, template
  overrides, and Idea_Record field definitions
...
- [ ] 6. Implement dynamic Idea_Record builder
...
- [ ] 7. Implement Idea_Record structure validation
...
- [ ] 8. Wire template loader and dynamic schema into the pipelines
  - Pass the resolved keyword/idea templates and built Idea_Record model into Req 03/04
...
- [ ] 9. Write unit tests
  ...
  - Idea_Record: default fields when none; reject 0 fields, 21 fields, empty name, 65-char name, duplicate name
